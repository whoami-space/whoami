<script>
 ...
 <div class="w-full flex justify-center items-center">
    <button class="mt-minimal bg-3 text-2 font-bold rounded-xl mx-auto text-minimal cursor-pointer"><a target="_blank" href={`${mailto}?subject=${value}`} class="redirect p-minimal flex  justify-center items-center  gap-2">Send by email<AnnotationSolid class="w-minimal h-minimal" /></a></button>
 </div>